...
#### [Full Code](https://github.com/111coding/flutter_circle_gauge)
...
class CircleGauge extends StatefulWidget {
  const CircleGauge({Key? key, required this.percent, required this.width}) : super(key: key);
  final double width;
...
class _CircleGaugeState extends State<CircleGauge> with SingleTickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
    // 위젯이 그려지고 난 후 호출
  ...
  late final aimationController = AnimationController(vsync: this, duration: const Duration(milliseconds: 1000));
...
#### [Result](https://111coding.github.io/example/circle_gauge/#/)
<iframe height="600px" src="https://111coding.github.io/example/circle_gauge/#/"></iframe>